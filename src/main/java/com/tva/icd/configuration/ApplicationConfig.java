...
public class ApplicationConfig {
  ...
  public MongoDbFactory mongoDbFactory() throws Exception {
    ...
    MongoClientOptions options = MongoClientOptions.builder().readPreference(ReadPreference.primaryPreferred()).retryWrites(true).requiredReplicaSetName("Cluster0-shard-0").maxConnectionIdleTime(6000)
