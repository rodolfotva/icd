...
public class GroupController {
  ...
  public ResponseEntity<Map<String, Object>> getGroupsByChapterandCategory(@PathVariable("categoryId") String categoryId) {
    ...
    List<Group> groupLst =
        groupService.getGroupByCategory(categoryId, LocaleContextHolder.getLocale().getLanguage()).stream().sorted((u1, u2) -> u1.getId().compareTo(u2.getId())).collect(Collectors.toList());
