...
public class ChapterController {
  ...
  public ResponseEntity<List<Chapter>> listAllChapters() {
    ...
    List<Chapter> chapters =
        chapterService.getAllChapters(LocaleContextHolder.getLocale().getLanguage()).stream().sorted((u1, u2) -> u1.getIntId().compareTo(u2.getIntId())).collect(Collectors.toList());
  ...
  public ResponseEntity<Chapter> updateChapter(@PathVariable("chapterId") String chapterId, @RequestBody Chapter chapter) {
